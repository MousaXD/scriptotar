...
def validate_reference(value: str) -> str | None:
    ...
    if value.startswith("docker://"):
        # Docker step actions are not repository actions. This checker deliberately
        # scopes itself to GitHub repository actions; container image pinning should
        # be enforced by a dedicated image policy if such steps are introduced.
        return None
